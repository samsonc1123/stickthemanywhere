...
const SUBCATEGORIES: { categoryCode: string; code: string; name: string; sortOrder: number }[] = [
  ...
  { categoryCode: "GAMING", code: "DMH", name: "Demon Hunters", sortOrder: 4 },
  { categoryCode: "GAMING", code: "ZEL", name: "Zelda",         sortOrder: 5 },
  { categoryCode: "GAMING", code: "MAS", name: "Master Chief",  sortOrder: 6 },
  { categoryCode: "GAMING", code: "MCR", name: "Minecraft",     sortOrder: 7 },
  { categoryCode: "GAMING", code: "ROB", name: "Roblox",        sortOrder: 8 },
  { categoryCode: "GAMING", code: "PKM", name: "Pokémon",       sortOrder: 9 },
  { categoryCode: "GAMING", code: "FOR", name: "Fortnite",      sortOrder: 10 },
  { categoryCode: "GAMING", code: "AUS", name: "Among Us",      sortOrder: 11 },
  { categoryCode: "GAMING", code: "FLG", name: "Flags",         sortOrder: 12 },
  ...
  // MOVIES
  { categoryCode: "MOVIES", code: "MOV-AVN", name: "Avengers",                   sortOrder: 1  },
  { categoryCode: "MOVIES", code: "MOV-BAT", name: "Batman",                     sortOrder: 2  },
  { categoryCode: "MOVIES", code: "MOV-FAF", name: "Fast & Furious",             sortOrder: 3  },
  { categoryCode: "MOVIES", code: "MOV-GHB", name: "Ghostbusters",               sortOrder: 4  },
  { categoryCode: "MOVIES", code: "MOV-GRS", name: "Grease",                     sortOrder: 5  },
  { categoryCode: "MOVIES", code: "MOV-HLW", name: "Halloween",                  sortOrder: 6  },
  { categoryCode: "MOVIES", code: "MOV-HPT", name: "Harry Potter",               sortOrder: 7  },
  { categoryCode: "MOVIES", code: "MOV-HNG", name: "Hunger Games",               sortOrder: 8  },
  { categoryCode: "MOVIES", code: "MOV-INJ", name: "Indiana Jones",              sortOrder: 9  },
  { categoryCode: "MOVIES", code: "MOV-JKR", name: "Joker",                      sortOrder: 10 },
  { categoryCode: "MOVIES", code: "MOV-JRP", name: "Jurassic Park",              sortOrder: 11 },
  { categoryCode: "MOVIES", code: "MOV-LTR", name: "Lord of the Rings",          sortOrder: 12 },
  { categoryCode: "MOVIES", code: "MOV-MTX", name: "Matrix",                     sortOrder: 13 },
  { categoryCode: "MOVIES", code: "MOV-NBC", name: "Nightmare Before Christmas", sortOrder: 14 },
  { categoryCode: "MOVIES", code: "MOV-POC", name: "Pirates of the Caribbean",   sortOrder: 15 },
  { categoryCode: "MOVIES", code: "MOV-RCK", name: "Rocky",                      sortOrder: 16 },
  { categoryCode: "MOVIES", code: "MOV-STK", name: "Star Trek",                  sortOrder: 17 },
  { categoryCode: "MOVIES", code: "MOV-STW", name: "Star Wars",                  sortOrder: 18 },
  { categoryCode: "MOVIES", code: "MOV-TRM", name: "Terminator",                 sortOrder: 19 },
  { categoryCode: "MOVIES", code: "MOV-TGN", name: "Top Gun",                    sortOrder: 20 },
  { categoryCode: "MOVIES", code: "MOV-TRF", name: "Transformers",               sortOrder: 21 },
  { categoryCode: "MOVIES", code: "MOV-TWL", name: "Twilight",                   sortOrder: 22 },
  { categoryCode: "MOVIES", code: "MOV-WOZ", name: "Wizard of Oz",               sortOrder: 23 },
