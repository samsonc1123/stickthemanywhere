...
const SUBCATEGORIES = [
  { name: "MAGA",          code: "MAG" },
  { name: "Trump",         code: "TRP" },
  { name: "Patriot",       code: "PAT" },
  { name: "Conservative",  code: "CON" },
  { name: "America First", code: "AMF" },
  { name: "Republican",    code: "REP" },
];
const ACCENT = "#ef4444";
const CAT = "TRUMP";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Trump</h1>
      </div>
