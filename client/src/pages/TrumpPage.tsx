...
export default function TrumpPage() {
  const subcategories = [
    { name: "MAGA", color: "bg-red-500" },
    { name: "Trump", color: "bg-red-500" },
    { name: "Patriotic", color: "bg-red-500" },
    { name: "Conservative", color: "bg-red-500" },
    { name: "American Flag", color: "bg-red-500" },
    { name: "Republican", color: "bg-red-500" }
  ];
