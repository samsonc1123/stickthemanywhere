...
export default function StaticClingPage() {
  const [activeCode, setActiveCode] = useState<string | null>(null);
  const rawData = useQuery(api.stickers.getStaticClingStickers);
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>
          Static Cling PVC
        </h1>
      </div>
                    ...
                    >
                      {stickers.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 w-full h-full px-3 text-center">
                          ...
                          <span className="text-gray-500 text-[9px] font-mono uppercase tracking-wider">
                            Coming Soon
                          </span>
                        </div>
                      )}
