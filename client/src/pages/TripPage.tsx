...
const SUBCATEGORIES = [
  { name: "Mushrooms",    code: "MUSHROOMS" },
  { name: "Frogs",        code: "FROGS" },
  { name: "Trip Animals", code: "TRIP-ANIMALS" },
  { name: "Aliens",       code: "ALIENS" },
  { name: "Words",        code: "WORDS" },
  { name: "Circles",      code: "CIRCLES" },
  { name: "Squares",      code: "SQUARES" },
];
const ACCENT = "#a855f7";
const CAT = "TRIP";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Trip</h1>
      </div>
