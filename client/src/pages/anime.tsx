...
const subcategoriesData = [
  { name: 'Demon Slayer', color: 'bg-neon-aqua' },
  { name: 'Hunter X Hunter', color: 'bg-neon-aqua' },
  { name: 'Attack on Titan', color: 'bg-neon-aqua' },
  { name: 'Dragon Ball Z', color: 'bg-neon-aqua' },
  { name: 'Pokémon', color: 'bg-neon-aqua' },
];
