...
const SUBCATEGORIES = [
  { name: "Classic Cars",   code: "CLASSIC" },
  { name: "Diesel Trucks",  code: "DIESEL" },
  { name: "Dirt Track",     code: "DIRT-TRACK" },
  { name: "Fantasy Cars",   code: "FANTASY" },
  { name: "Jeeps",          code: "JEEPS" },
  { name: "Luxury Cars",    code: "LUXURY" },
  { name: "Muscle Cars",    code: "MUSCLE" },
  { name: "Pick-Up Trucks", code: "PICK-UP" },
  { name: "Race Cars",      code: "RACE" },
  { name: "SUVs",           code: "SUVS" },
  { name: "Super Sports",   code: "SUPER-SPORTS" },
];
const ACCENT = "#f97316";
const CAT = "CARS";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Cars</h1>
      </div>
