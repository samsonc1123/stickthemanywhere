...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2">
      ...
      >
        {["90's Cartoons", "Animated Series", "Animals", "Anime", "Cars", "Christian", "Disney", "Dragons", "Fashion", "Flowers", "Food & Drink", "Gaming", "Hello Kitty", "Kawaii", "Hispanic", "Marijuana", "Memes", "Movies", "Musicians", "Pokemon", "Sports", "Psychedelic", "Static Cling", "Trump", "TV Shows", "Unicorns"].map((cat) => {
          const href = cat === "Flowers" ? "/flowers" : cat === "Fashion" ? "/fashion" : cat === "Kawaii" ? "/kawaii" : cat === "Hello Kitty" ? "/hellokitty" : cat === "Marijuana" ? "/marijuana" : cat === "Trump" ? "/trump" : cat === "Hispanic" ? "/hispanic" : cat === "Pokemon" ? "/pokemon" : cat === "Animated Series" ? "/animatedseries" : cat === "Food & Drink" ? "/food-drink" : cat === "Psychedelic" ? "/trip" : cat === "90's Cartoons" ? "/" : cat === "Disney" ? "/disney" : cat === "Unicorns" ? "/unicorns" : cat === "Dragons" ? "/dragons" : cat === "Musicians" ? "/musicians" : cat === "Static Cling" ? "/static-cling" : `/${cat.toLowerCase().replace(/\s/g, '')}`;
        
        
          return (
            <Link key={cat} href={href}>
              <button 
                className={`inline-block rounded-full ${cat === "Trump" ? "relative overflow-hidden" : cat === "Christian" ? "bg-yellow-400" : cat === "Fashion" ? "relative overflow-hidden" : cat === "Flowers" ? "bg-pink-300" : cat === "Kawaii" ? "bg-purple-500" : cat === "Hello Kitty" ? "bg-neon-pink" : cat === "Unicorns" ? "bg-pink-400" : cat === "Dragons" ? "bg-red-600" : cat === "Marijuana" ? "relative overflow-hidden" : cat === "Hispanic" ? "bg-orange-500" : cat === "Pokemon" ? "bg-neon-yellow" : cat === "Disney" ? "bg-blue-400" : cat === "Psychedelic" ? "relative overflow-hidden" : cat === "Musicians" ? "" : cat === "Cars" ? "" : cat === "Static Cling" ? "" : "bg-neon-aqua"} px-4 py-2 mx-1 font-montserrat`}
                style={cat === "Trump" ? { 
                  color: 'black',
      ...
      <div className="w-full">
        <div className="flex justify-center pb-4 landscape:pb-16">
          <div className="grid grid-cols-1 landscape:grid-cols-2 md:grid-cols-2 md:landscape:grid-cols-4 gap-3 landscape:gap-4 md:gap-5 max-w-lg landscape:max-w-4xl md:max-w-2xl md:landscape:max-w-6xl px-4">
            {["90's Cartoons", "Animated Series", "Animals", "Anime", "Cars", "Christian", "Disney", "Dragons", "Fashion", "Flowers", "Food & Drink", "Gaming", "Hello Kitty", "Kawaii", "Hispanic", "Marijuana", "Memes", "Movies", "Musicians", "Pokemon", "Sports", "Psychedelic", "Static Cling", "Trump", "TV Shows", "Unicorns"].map((cat, i) => (
