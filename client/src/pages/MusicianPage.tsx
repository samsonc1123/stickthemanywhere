...
const SUBCATEGORIES = [
  { name: "Adele",             code: "MUS-ADE" },
  { name: "Ariana Grande",     code: "MUS-ARI" },
  { name: "Beyoncé",           code: "MUS-BEY" },
  { name: "Billie Eilish",     code: "MUS-BIL" },
  { name: "Bruno Mars",        code: "MUS-BRU" },
  { name: "Dua Lipa",          code: "MUS-DUA" },
  { name: "Ed Sheeran",        code: "MUS-EDS" },
  ...
  { name: "Selena Gomez",      code: "MUS-SEL" },
  { name: "Shakira",           code: "MUS-SHA" },
  { name: "SZA",               code: "MUS-SZA" },
  { name: "Taylor Swift",      code: "MUS-TAY" },
];
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Musicians</h1>
      </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: "black",
                    boxShadow: lit ? `0 0 8px ${ACCENT}, 0 0 16px ${ACCENT}88` : "none",
          ...
          <div className="grid grid-cols-1 landscape:grid-cols-2 md:grid-cols-2 md:landscape:grid-cols-4 gap-3 landscape:gap-4 md:gap-5 max-w-lg landscape:max-w-4xl md:max-w-2xl md:landscape:max-w-6xl px-4">
            {isLoading
              ? [...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="w-52 h-52 border-4 flex items-center justify-center"
                  ...
                  return (
                    <div
                      ...
                      style={{
                        borderColor: ACCENT,
                        boxShadow: lit
                          ? `0 0 12px ${ACCENT}, 0 0 24px ${ACCENT}55, inset 0 0 10px ${ACCENT}22`
                          : `0 0 5px ${ACCENT}44`,
                        transition: "box-shadow 0.4s",
                      }}
                    >
