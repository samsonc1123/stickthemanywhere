...
const SUBCATEGORIES = [
  { name: "Kermit",        code: "KERMIT" },
  { name: "Mr. Bean",      code: "MR-BEAN" },
  { name: "Cartoon Baby",  code: "CARTOON-BABY" },
  { name: "Troll Face",    code: "TROLL" },
  { name: "Grumpy Cat",    code: "GRUMPY-CAT" },
  { name: "Drake",         code: "DRAKE" },
  { name: "SpongeBob",     code: "SPONGEBOB" },
  { name: "Distracted BF", code: "DISTRACTED" },
];
const ACCENT = "#eab308";
const CAT = "MEMES";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Memes</h1>
      </div>
