...
import { wordsInFlowers, flowersAndWords, flowersAroundWords } from '../stickers/floralStickers';
      ...
      <div className="flex-1 overflow-y-auto w-full">
        <div className="flex justify-center pb-4 landscape:pb-16">
          <div className="grid grid-cols-1 landscape:grid-cols-2 gap-12 landscape:gap-12 max-w-lg landscape:max-w-4xl px-4">
            <StickerCarousel stickers={wordsInFlowers} />
            <StickerCarousel stickers={flowersAndWords} />
            <StickerCarousel stickers={flowersAroundWords} />
          </div>
        </div>
      </div>
    </div>
