...
const SUBCATEGORIES = [
  ...
  { name: "Pho",     code: "PHO" },
  { name: "Pizza",   code: "PIZ" },
  { name: "Burgers", code: "BUR" },
  { name: "Sweets",  code: "SWE" },
  { name: "Coffee",  code: "COF" },
  { name: "Boba",    code: "BOB" },
];
const ACCENT = "#f59e0b";
const CAT = "FOOD-DRINK";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Food &amp; Drink</h1>
      </div>
