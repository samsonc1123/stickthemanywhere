...
const SUBCATEGORIES = [
  ...
  { name: "Moana",              code: "MOA" },
  { name: "Encanto",            code: "ENC" },
  { name: "Tangled",            code: "TNG" },
  { name: "Finding Nemo",       code: "FNM" },
  { name: "Monsters Inc",       code: "MON" },
  { name: "Little Mermaid",     code: "TLM" },
  { name: "Mickey & Friends",   code: "MKF" },
  { name: "Winnie the Pooh",    code: "WTP" },
  { name: "Cinderella",         code: "CND" },
  { name: "Beauty & the Beast", code: "BTB" },
  { name: "Disney Shorts",      code: "DS" },
];
const ACCENT = "#60a5fa";
const CAT = "DISNEY";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Disney</h1>
      </div>
