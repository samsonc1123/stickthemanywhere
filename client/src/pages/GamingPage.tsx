...
const SUBCATEGORIES = [
  ...
  { name: "Pokémon",      code: "PKM" },
  { name: "Fortnite",     code: "FOR" },
  { name: "Among Us",     code: "AUS" },
  { name: "Flags",        code: "FLG" },
];
const ACCENT = "#4ade80";
const CAT = "GAMING";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Gaming</h1>
      </div>
