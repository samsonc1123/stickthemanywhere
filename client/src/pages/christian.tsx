...
const SUBCATEGORIES = [
  { name: "King James",  code: "KJ" },
  { name: "God",         code: "GOD" },
  { name: "Holy Spirit", code: "HS" },
  { name: "Scripture",   code: "SCR" },
  { name: "Cross",       code: "CRS" },
  { name: "Heart",       code: "HRT" },
];
const ACCENT = "#eab308";
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      <div className="text-center mb-4 lg:mb-1">
        <h1 className="font-bold animate-categoriesFlicker font-audiowide text-lg" style={{ color: ACCENT }}>Christian</h1>
      </div>
